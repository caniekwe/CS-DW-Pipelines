...
DAG_ID = "cholera_sitrep_datamart_pipeline"
        ...
        try:
            ...
            cur.execute("""
                ...
                SELECT
                    ...
                    c.sex,
                    CASE 
                        WHEN e.labresult_rdt = 'positive' OR e.labresult_cul = 'positive' THEN 'positive' 
                        WHEN (e.labresult_rdt = 'negative' OR e.labresult_cul = 'negative') AND e.labresult_cul != 'positive' AND e.labresult_rdt != 'positive' THEN 'negative'
                        ELSE COALESCE (e.labresult_rdt, e.labresult_cul) 
                    END AS result,
                    c.outcome
                ...
                LEFT JOIN ext_cholera_case e ON c.case_fact_id = e.case_id
                WHERE d.disease_name = 'Cholera'
